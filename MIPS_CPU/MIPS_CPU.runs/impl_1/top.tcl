...
set rc [catch {
  ...
  set_property ip_repo_paths d:/project/MIPS/USTC-tMIPS/MIPS_CPU/MIPS_CPU.cache/ip [current_project]
  set_property ip_output_repo d:/project/MIPS/USTC-tMIPS/MIPS_CPU/MIPS_CPU.cache/ip [current_project]
  add_files -quiet D:/project/MIPS/USTC-tMIPS/MIPS_CPU/MIPS_CPU.runs/synth_1/top.dcp
