...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports clk_orig]
set_property IOSTANDARD LVCMOS33 [get_ports clk_orig]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk_orig]
#create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 5} [get_ports top/clk]
